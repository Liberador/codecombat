...
#    meta_description: "Aprende a programar a través de un juego de programación. Aprende Python, JavaScript, y HTML mientras solucionas puzzles y aprendes a programar tus propios juegos y sitios web."
#    meta_og_url: "https://codecombat.com"
#    become_investor: "Hazte inversor de CodeCombat"
#    built_for_teachers_title: "Un Juego de programación construído pensando en los profesores"
#    built_for_teachers_blurb: "Enseñar a los jóvenes programación puede parecer abrumador. CodeCombat ayuda a todos los educadores a enseñar a estudiantes students como programar tanto en JavaScript como en Python, dos de los lenguajes de programación más populares. ¡Con un plan de estudios integral que incluye seis unidades de informática y refuerza el aprendizaje a través del desarrollo de juegos basados en proyectos y unidades de desarrollo web, los niños avanzarán en un viaje desde la sintaxis básica hasta la recursividad!"
#    built_for_teachers_subtitle1: "Informática"
#    built_for_teachers_subblurb1: "Comenzando con nuestro curso gratuito de Introducción a las Ciencias de la Computación, los estudiantes dominan los conceptos básicos de codificación, como bucles while / for, funciones y algoritmos.."
#    built_for_teachers_subtitle2: "Desarrollo de Juegos"
#    built_for_teachers_subblurb2: "Los alumnos construyen laberintos y utilizan el manejo de entrada básico para codificar sus propios juegos que se pueden compartir con amigos y familiares."
#    built_for_teachers_subtitle3: "Desarrollo Web"
#    built_for_teachers_subblurb3: "Usando HTML, CSS y jQuery, los alumnos ejercitan sus músculos creativos para programar sus propias páginas web con una URL personalizada para compartir con sus compañeros de clase.."
    century_skills_title: "Habilidades del siglo 21"
#    century_skills_blurb1: "Los estudiantes no solo suben de nivel a su héroe, ellos mismos suben de nivel"
#    century_skills_quote1: "Te equivocas ... entonces piensas en todas las formas posibles de solucionarlo y luego vuelves a intentarlo. No podría llegar aquí sin esforzarme."
#    century_skills_subtitle1: "Pensamiento Crítico"
#    century_skills_subblurb1: "Con acertijos de codificación que se adaptan naturalmente a niveles cada vez más desafiantes, el juego de programación de CodeCombat garantiza que los niños siempre practiquen el pensamiento crítico."
